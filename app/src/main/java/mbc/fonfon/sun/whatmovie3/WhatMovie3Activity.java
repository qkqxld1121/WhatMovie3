...
public class WhatMovie3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_what_movie3);
        ...
        cursor = sqlDB.rawQuery("SELECT * FROM movieDRAMA order by open desc",null);
